...
public class Ejercicio9 {
    public static void main(String[] args) {
        ...
        if (sillas > 39) {
            ...
            System.out.println("El total de su pedido con el 30% de descuento es: " + precioTotal);
        } else if (sillas > 11) {
            precioTotal = (sillas * PRECIO_SILLA) - (sillas * PRECIO_SILLA) * 0.2;
            System.out.println("El total de su pedido con el 20% de descuento es: " + precioTotal);
        } else if (sillas > 4) {
            precioTotal = (sillas * PRECIO_SILLA) - (sillas * PRECIO_SILLA) * 0.1;
            System.out.println("El total de su pedido con el 10% de descuento es: " + precioTotal);
        } else
